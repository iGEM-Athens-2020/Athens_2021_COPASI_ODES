...
<!-- generated with COPASI 4.34 (Build 251) (http://www.copasi.org) at 2021-10-14T13:50:33Z -->
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
      ...
      <Metabolite key="Metabolite_10" name="RNR" simulationType="ode" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"/>

        </MiriamAnnotation>
        <Expression>
          30/60*(0.5/60)/(0.462/60)*17*&lt;CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[IPTG],Reference=Concentration>/(0.0025e-6+&lt;CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[IPTG],Reference=Concentration>)-0.2/60*&lt;CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[RNR],Reference=Concentration>
        </Expression>
      </Metabolite>
      <Metabolite key="Metabolite_11" name="TSase" simulationType="ode" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"/>

        </MiriamAnnotation>
        <Expression>
          30/60*(0.5/60)/(0.462/60)*17*&lt;CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[AraC],Reference=Concentration>/(2e-9+&lt;CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[AraC],Reference=Concentration>)-0.2/60*&lt;CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[TSase],Reference=Concentration>
        </Expression>
      </Metabolite>
      <Metabolite key="Metabolite_12" name="IPTG" simulationType="fixed" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"/>

        </MiriamAnnotation>
      </Metabolite>
      <Metabolite key="Metabolite_13" name="AraC" simulationType="fixed" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"/>
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_6195" name="k_cat" value="1.4"/>
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_5572" name="k_cat" value="3"/>
        </ListOfConstants>
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_5929" name="k_cat" value="4.4"/>
        </ListOfConstants>
        <KineticLaw function="Function_42" unitType="Default" scalingCompartment="CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_293">
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[RNR]" value="6022140.7599999998" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[TSase]" value="6022140.7599999998" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[IPTG]" value="602214.07600000082" type="Species" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[AraC]" value="301107.03800000012" type="Species" simulationType="fixed"/>
        </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0 6022140.7599999998 6022140.7599999998 28304061.572000004 78890043.955999985 39746129.016000003 77685615.80400002 109602961.83199991 49983768.307999983 33121774.18 86718826.943999991 23486348.963999994 1535645893.7999995 602214.07600000082 301107.03800000012 9.9999999999999998e-13 0.00040000000000000002 0.0050000000000000001 0.040000000000000001 0.40000000000000002 1.3200000000000001 0.01 0.0060000000000000001 0.050000000000000003 0.0040000000000000001 1.3999999999999999 0.0097999999999999997 1.3999999999999999 8 3 4.4000000000000004 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_19" name="Scan" type="scan" scheduled="false" updateModel="false">
      <Report reference="Report_22" target="tes2_RNR_TSase_transient_new_Ki_kcat.txt" append="0" confirmOverwrite="1"/>
      <Problem>
