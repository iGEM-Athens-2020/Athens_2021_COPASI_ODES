...
<!-- generated with COPASI 4.34 (Build 251) (http://www.copasi.org) at 2021-10-17T15:46:02Z -->
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        ...
        <Expression>
          30/60*(0.5/60)/(0.462/60)*17*&lt;CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[IPTG],Reference=Concentration>/(0.0025e-6+&lt;CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[IPTG],Reference=Concentration>)-0.2/60*&lt;CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[TSase],Reference=Concentration>
        </Expression>
      </Metabolite>
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=RNR_TSase_fixed,Vector=Compartments[Cell],Vector=Metabolites[IPTG]" value="602214.07600000012" type="Species" simulationType="fixed"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_19" name="Scan" type="scan" scheduled="false" updateModel="false">
      <Report reference="Report_22" target="new_test3_16_10.txt" append="0" confirmOverwrite="1"/>
      <Problem>
